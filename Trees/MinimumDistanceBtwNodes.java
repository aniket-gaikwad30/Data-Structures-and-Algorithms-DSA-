...
public class MinimumDistanceBtwNodes {
    ...
    public static int findDistance(Node root, int n1, int n2) {
        ...
        ArrayList<Node> pathToN1 = new ArrayList<>();
        findPath(lca, n1, pathToN1);
        ArrayList<Node> pathToN2 = new ArrayList<>();
        findPath(lca, n2, pathToN2);

        return (pathToN1.size() + pathToN2.size() - 2);
    }
    ...
    public static void main(String[] args) {
        ...
        if (distance != -1) {
            ...
            System.out.println("Nodes not found in the tree.");
        }
    }
}
